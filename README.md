...
- **Detection:** Splunk Enterprise Security (SPL), Microsoft Sentinel (KQL), Sigma.
- **Response:** Microsoft Defender, Cortex XSOAR.
- **Languages:** Python, Rust, PowerShell, C, x86 assembly.
